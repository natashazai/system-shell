...
void run_foreground_commands(int input_flag, int output_flag,
                             char input_file[20], char output_file[20],
                             char **args);
void run_background_commands(int input_flag, int output_flag,
                             char input_file[20], char output_file[20],
                             char **args, int args_num, int background_flag);
...
void handle_commands(char user_input_command[]){
    ...
    if(background_flag == 0){
        run_foreground_commands(input_flag, output_flag,
        ...
        if(foreground_only_flag == 1){
            ...
            run_background_commands(input_flag, output_flag,
                                    input_file, output_file,
                                    args, args_num, background_flag);
        }
    }
}
